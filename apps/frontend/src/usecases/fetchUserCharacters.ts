...
export const characters: Character[] = [
  {
    ...
    enemies: [{ id: "harmony-cobel", name: "Harmony Cobel", description: "Mark's overbearing boss at Lumon" }],
    family: [{ id: "devon-scout", name: "Devon Scout", description: "Mark's supportive sister" }],
    mentors: [],
    mentees: [],
    rivals: [],
    loveInterests: [],
    friends: [{ id: "irving-b", name: "Irving B.", description: "Fellow severed employee at Lumon" }]
  },
  {
    id: "helly-r",
    narrative: "57832327-c949-4968-af7d-45e737fhdjdjd874j4",
    ...
    updatedAt: new Date().toISOString(),
    new: false,
    allies: [{ id: "mark-scout", name: "Mark Scout", description: "Helly's fellow severed employee" }],
    enemies: [{ id: "harmony-cobel", name: "Harmony Cobel", description: "Helly's overbearing supervisor" }],
    family: [],
    mentors: [],
    mentees: [],
    rivals: [],
  ...
  },
  {
    ...
    updatedAt: new Date().toISOString(),
    new: false,
    allies: [{ id: "mark-scout", name: "Mark Scout", description: "Irving's fellow severed employee" }],
    enemies: [{ id: "harmony-cobel", name: "Harmony Cobel", description: "Irving's overbearing boss" }],
    family: [],
    mentors: [],
    mentees: [],
    rivals: [],
    loveInterests: [],
    friends: [{ id: "mark-scout", name: "Mark Scout", description: "Irving's fellow severed employee" }]
  },
  {
    id: "dylan",
    narrative: "57832327-c949-4968-af7d-45e737fhdjdjd874j4",
    ...
    enemies: [{ id: "harmony-cobel", name: "Harmony Cobel", description: "Dylan's overbearing superior at Lumon" }],
    family: [],
    mentors: [],
    mentees: [],
    rivals: [],
  ...
  },
  {
    ...
    updatedAt: new Date().toISOString(),
    new: false,
    allies: [{ id: "harmony-cobel", name: "Harmony Cobel", description: "Overseer of severed employees" }],
    enemies: [{ id: "mark-scout", name: "Mark Scout", description: "Harmony's target in her efforts to maintain control" }],
    family: [],
    mentors: [],
    mentees: [],
    rivals: [],
