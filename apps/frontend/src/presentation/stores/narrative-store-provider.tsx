...
import { type NarrativeStore, createNarrativeStore, initNarrativeStore } from './narrative-store';
...
export const NarrativeStoreProvider = ({ children }: NarrativeStoreProviderProps) => {
...
export const useNarrativeStore = <T,>(selector: (store: NarrativeStore) => T): T => {
